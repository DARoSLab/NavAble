"""Backend package for the NavAble Synthetic Data Extension extension.

Pure-Python + Isaac-Sim-facing modules that encapsulate all non-UI
behavior.  The UI (``navable_synth_data_collector.ui``) and the headless CLI
(``navable_synth_data_collector.cli``) both import from this package.
