"""Tests for :mod:`navable_synth_data_collector.backend.config`."""
...
from navable_synth_data_collector.backend import config as cfg
...
def test_malformed_yaml_falls_back_to_defaults(tmp_path):
    ...
    assert d.camera_path == "/World/Camera"  # unchanged default
