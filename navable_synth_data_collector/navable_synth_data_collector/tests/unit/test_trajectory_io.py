"""Tests for :mod:`navable_synth_data_collector.backend.trajectory_io`."""

from __future__ import annotations

import json

from navable_synth_data_collector.backend import trajectory_io as tio
...
def test_build_trajectory_payload_has_expected_shape():
    ...
    assert data["camera_path"] == "/World/Camera"
    assert data["fps"] == 60
