...
Usage::
    ...
    from navable_synth_data_collector.cli import bootstrap
...
def start_sim(
    ...
    """
    # Imported inside the function so ``navable-collect list`` doesn't pay
    ...
    ext_mgr.set_extension_enabled_immediate("navable_synth_data_collector", True)
    return app
