...
:mod:`navable_synth_data_collector.backend.session`) and forwards every
...
class DataCollectorWindow:
    """Single-window UI for the NavAble Synthetic Data Extension extension."""
    ...
    def __init__(self) -> None:
        ...
        self._update_sub = (
            ...
            .create_subscription_to_pop(self._on_update, name="navable_synth_data_collector.ui.tick")
        )
        ...
        for section in (self._traj_play, self._rwt, self._assets):
            if hasattr(section, "refresh"):
                try:
                    ...
                    carb.log_warn(f"[NavAble] Section refresh failed: {exc}")
    ...
    def _on_update(self, event) -> None:
        for section in self._sections:
            try:
                ...
                carb.log_warn(f"[NavAble] Section tick failed: {exc}")
    ...
    def destroy(self) -> None:
        ...
        try:
            ...
            carb.log_warn(f"[NavAble] Session destroy failed: {exc}")
