...
# Paths
input_dir = r'D:\GuideDog Data\Synthetic Data\Set 4\Annotations\rgb'  # Replace with the folder containing 1920x1080 images
output_dir = r'D:\GuideDog Data\Synthetic Data\Set 4\SAM2_Dataset'  # Replace with the folder to save resized images
