...
image_dir = r"D:\GuideDog Data\Synthetic Data\Set 5\SAM2.1_Dataset_Refined"  # Directory containing all the images
label_dir =  r"D:\GuideDog Data\Synthetic Data\Set 5\SAM2.1_Dataset_Refined"  # Directory containing YOLO format label files
output_base_dir = r'D:\GuideDog Data\Synthetic Data\Set 5\COCO_Dataset'  # Output directory for training/validation/test sets
...
train_image_dir = os.path.join(output_base_dir, 'train') # os.path.join(output_base_dir, 'train/images')
val_image_dir = os.path.join(output_base_dir, 'val') # os.path.join(output_base_dir, 'val/images')
test_image_dir = os.path.join(output_base_dir, 'test') # os.path.join(output_base_dir, 'test/images')
train_label_dir = os.path.join(output_base_dir, 'train') # os.path.join(output_base_dir, 'train/labels')
val_label_dir = os.path.join(output_base_dir, 'val') # os.path.join(output_base_dir, 'val/labels')
test_label_dir = os.path.join(output_base_dir, 'test') # os.path.join(output_base_dir, 'test/labels')
...
labels = [f.replace('.jpg', '.json') for f in images]  # Assumes labels match the image names
