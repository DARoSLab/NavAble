"""SegFormer Final-B: real + opensrc training, real-only eval. Paper-canonical baseline.

- ADE20k pretrained init.
- Train: ConcatDataset(real_final/train + opensrc_final/train) = 3,703 + 36,466 = 40,169 imgs.
- Val:   data/real_final/val (396 imgs) — best-ckpt selected by REAL-domain mIoU.
- Test:  data/real_final/test (1,482 imgs).
- 60,000 iters at batch 10 (~15 epochs over combined). Stage-1 baseline iters.
"""
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='segformer-final-b-real-opensrc',
            tags=['final', 'configB', 'segformer'],
        ),
    ),
]
