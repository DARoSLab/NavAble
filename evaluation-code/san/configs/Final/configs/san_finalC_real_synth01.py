"""SAN Final-C: real ×6 + synth_0.1 mixed training, real-only eval. Scaling experiment 1.
...
- 90,000 iters at batch 24 (~16h budget at ~5.6K iters/h).
"""
...
param_scheduler = [
    dict(type='PolyLR', power=1.0, by_epoch=False, begin=0, end=90000, eta_min=0.0),
]

train_cfg = dict(type='IterBasedTrainLoop', max_iters=90000, val_begin=5000, val_interval=5000)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='san-final-c-real-synth01',
            tags=['final', 'configC', 'san'],
        ),
    ),
]
