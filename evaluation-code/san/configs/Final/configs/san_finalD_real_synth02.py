"""SAN Final-D: real ×12 + synth_0.2 mixed training, real-only eval. Scaling experiment 2.
...
- 180,000 iters at batch 24 (~32h budget at ~5.6K iters/h).
"""
...
param_scheduler = [
    dict(type='PolyLR', power=1.0, by_epoch=False, begin=0, end=180000, eta_min=0.0),
]

train_cfg = dict(type='IterBasedTrainLoop', max_iters=180000, val_begin=10000, val_interval=10000)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='san-final-d-real-synth02',
            tags=['final', 'configD', 'san'],
        ),
    ),
]
