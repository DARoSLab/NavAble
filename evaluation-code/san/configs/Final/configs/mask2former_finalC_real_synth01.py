"""Mask2Former Final-C: real ×6 + synth_0.1 mixed training, real-only eval. Scaling experiment 1.
...
- 110,000 iters at batch 4 (~16h budget at ~6.9K iters/h).
"""
...
param_scheduler = [
    ...
    dict(type='PolyLR', power=0.9, by_epoch=False, begin=500, end=110000, eta_min=0.0),
]

train_cfg = dict(type='IterBasedTrainLoop', max_iters=110000, val_begin=5000, val_interval=5000)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='mask2former-final-c-real-synth01',
            tags=['final', 'configC', 'mask2former'],
        ),
    ),
]
