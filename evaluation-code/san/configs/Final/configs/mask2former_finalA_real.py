"""Mask2Former Final-A: real-only training, real-only eval. Paper-canonical baseline.
...
- 10,000 iters at batch 4 (~11 epochs over 3,703 imgs). Batch=4 mandatory; batch=8+AMP triggers NaN loss_mask.
"""
...
param_scheduler = [
    ...
    dict(type='PolyLR', power=0.9, by_epoch=False, begin=300, end=10000, eta_min=0.0),
]
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='mask2former-final-a-real',
            tags=['final', 'configA', 'mask2former'],
        ),
    ),
]
