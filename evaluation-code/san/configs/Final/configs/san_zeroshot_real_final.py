"""SAN zero-shot eval on real_final/test (no BLV fine-tuning).

COCO-Stuff pretrained SAN with BLV class text prompts. CLIP text encoder
queries directly for BLV classes — no weight updates. Honest BLVMetric.
"""
...
# COCO-Stuff pretrained — no BLV fine-tuning
