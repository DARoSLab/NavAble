"""Mask2Former Final-D: real ×12 + synth_0.2 mixed training, real-only eval. Scaling experiment 2.
...
- 220,000 iters at batch 4 (~32h budget at ~6.9K iters/h).
"""
...
param_scheduler = [
    ...
    dict(type='PolyLR', power=0.9, by_epoch=False, begin=1000, end=220000, eta_min=0.0),
]

train_cfg = dict(type='IterBasedTrainLoop', max_iters=220000, val_begin=10000, val_interval=10000)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='mask2former-final-d-real-synth02',
            tags=['final', 'configD', 'mask2former'],
        ),
    ),
]
