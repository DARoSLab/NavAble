"""SAN Final-B: real + opensrc training, real-only eval. Paper-canonical baseline.
...
- 30,000 iters at batch 24 (Stage-1 baseline iters).
"""
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='san-final-b-real-opensrc',
            tags=['final', 'configB', 'san'],
        ),
    ),
]
