...
real_data_root = _os.path.join(_blv_root, 'data', 'real')
synthetic_data_root = _os.path.join(_blv_root, 'data', 'synthetic')
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='blv-seg',
            name='track-C-real-synthetic-segformer',
            tags=['finetune', 'real-synthetic', 'track-C', 'segformer'],
        ),
    ),
]
