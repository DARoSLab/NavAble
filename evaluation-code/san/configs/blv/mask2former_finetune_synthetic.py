...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=40000, val_begin=4000, val_interval=4000)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='blv-seg',
            name='stage-1-synthetic-only-mask2former',
            tags=['finetune', 'synthetic-only', 'stage-1', 'mask2former'],
        ),
    ),
]
