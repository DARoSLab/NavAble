"""SAN Stage-2D: mixed training on real_v2 + opensrc + synth_v2 (subsampled).
...
- COCO-stuff init (CLIP)
- 30,000 iters (= Stage-1)
- batch 24, lr 1e-4
"""
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='blv-seg',
            name='stage-2d-mixed-san',
            tags=['stage-2d', 'mixed-real-opensrc-synth', 'san', 'v2-schema'],
        ),
    ),
]
