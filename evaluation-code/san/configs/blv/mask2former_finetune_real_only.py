"""Mask2Former Stage-1Ronly: real_v2-only finetune (no opensrc).
...
- ADE20k pretrained init (same as Stage-1)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='blv-seg',
            name='stage-1Ronly-mask2former',
            tags=['stage-1Ronly', 'real-only', 'mask2former', 'v2-schema'],
        ),
    ),
]
