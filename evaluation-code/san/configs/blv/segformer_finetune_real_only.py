"""SegFormer Stage-1Ronly: real_v2-only finetune (no opensrc).

- ADE20k pretrained init
- 10,000 iters (real_v2 ~3.5k → ~28 epochs at batch 12)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='blv-seg',
            name='stage-1Ronly-segformer',
            tags=['stage-1Ronly', 'real-only', 'segformer', 'v2-schema'],
        ),
    ),
]
