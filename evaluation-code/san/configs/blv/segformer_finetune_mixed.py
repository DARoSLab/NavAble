"""SegFormer Stage-2D: mixed training on real_v2 + opensrc + synth_v2 (subsampled).
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='blv-seg',
            name='stage-2d-mixed-segformer',
            tags=['stage-2d', 'mixed-real-opensrc-synth', 'segformer', 'v2-schema'],
        ),
    ),
]
