#configs/my_model/[project-name]/realsyn/
...
# Disable AMP — avoids NaN in Hungarian matcher
optim_wrapper = dict(
    _delete_=True,
    type='OptimWrapper',
    optimizer=dict(
...
param_scheduler = [
    dict(type='LinearLR', start_factor=1e-6, by_epoch=False, begin=0, end=6000),
    dict(type='PolyLR', power=1.0, eta_min=0.0, by_epoch=False, begin=6000, end=324000),
]
