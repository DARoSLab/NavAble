#configs/my_model/[project-name]/realsyn_nocur_partial/

_base_ = ['../../../deeplabv3plus/deeplabv3plus_r101-d8_4xb4-80k_ade20k-512x512.py']

custom_imports = dict(
    imports=['mmseg.evaluation.fg_iou_metric'],
...
param_scheduler = [
    ...
    dict(type='PolyLR', power=0.9, eta_min=1e-4, by_epoch=False, begin=2500, end=120000),
]
