#configs/my_model/[project-name]/realsyn_nocur/
...
train_dataloader = dict(
    batch_size=4,  # per GPU. 4 GPUs -> effective batch 16
    num_workers=8,
...
# LR linear scaling: 1e-5 * (effective batch 16 / effective batch 8) = 2e-5
optim_wrapper = dict(
    _delete_=True,
    type='OptimWrapper',
    optimizer=dict(
